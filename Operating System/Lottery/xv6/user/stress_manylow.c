...
main(int argc, char *argv[])
{
   ...
   if (diff*100 >= (highdiff+lowdiff)*tol){
     printf(1,"check error: Expected the process with high tickets to get a similar number of ticks as the total number of ticks of the processes with low tickets, high ticks is %d, low is %d\n", highdiff,lowdiff);
     goto Cleanup;
   }
